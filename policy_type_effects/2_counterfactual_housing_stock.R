...
diffreg80<-sum(cf1$Single.Family.RegDiff[1:4])
diffreg90<-sum(cf1$Single.Family.RegDiff[5:14])
diffreg00<-sum(cf1$Single.Family.RegDiff[15:24])
diffreg10<-sum(cf1$Single.Family.RegDiff[25:29])
